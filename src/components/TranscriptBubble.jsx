...
export const TranscriptBubble = ({ 
  ...
  return (
    <div className={cn(
      'flex gap-3 mb-4 items-start transition-all duration-300',
      ...
      <div className={cn(
        "flex-1 transform transition-all duration-300",
        showAnimation && "animate-fade-in"
      )}>
        <div className={cn(
          'rounded-2xl py-3 px-4 inline-block max-w-[85%] shadow-md',
